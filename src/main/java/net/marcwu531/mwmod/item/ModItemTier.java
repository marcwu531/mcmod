...
public enum ModItemTier implements IItemTier {
    MUSHROOM(5,2500,10.0F,5.0F,50,
        () -> Ingredient.fromItems(ModItems.MUSHROOM.get())),

    WOODEN(6,5000,13.0F,7.0F,50,
            () -> Ingredient.fromItems(ModItems.MUSHROOM_WOODEN_INGOT.get()));
